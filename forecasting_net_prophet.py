...
Original file is located at
    https://colab.research.google.com/drive/1qwKMc_a0lo6rteASzfoFFgg6Ared_C5Y
...
may_vs_monthly_median = traffic_may_2020 / median_monthly_traffic

display(may_vs_monthly_median)
...
**Answer:** Relative to the monthly median the search traffic increased during May 2020.
...
trend_by_hour_dayofweek = df_mercado_trends.groupby(by=[df_mercado_trends.index.hour, df_mercado_trends.index.dayofweek]).sum()
...
**Answer:** Yes, there is a lack of search trends between hours 5 - 10 for almost every day of the week.
...
trend_by_weekofyear = df_mercado_trends.groupby(by=[df_mercado_trends.index.weekofyear]).mean()

trend_by_weekofyear.hvplot()

"""##### Answer the following question:

**Question:** Does the search traffic tend to increase during the winter holiday period (weeks 40 through 52)?

**Answer:** # Between weeks 40 through 52 the trend is upward, however relative to the rest of the year I wouldn't say that this is an increase, more like a seasonal increase.
...
**Answer:** Yes, the amount of search trends is positively correlated with the stock's closing price.
...
**Answer:** # There is a negative relationship between lagged search traffic and the stock volatility and a positive relationship between lagged search traffic and the stock price returns.
...
mercado_prophet_df = mercado_prophet_df.rename(columns={
    'index': 'ds',
    'Search Trends': 'y'
})
...
**Answer:** It seems to be trending downward.
...
forecast_mercado_trends = forecast_mercado_trends
...
**Answer:** Between the hours 20 and 22.
...
**Answer:** End of july/early august.
...
**Answer:** We expect sales to be 969.607769, with a best case and worst case scenario of 1050.972372 and 887.943972 respectively.
"""